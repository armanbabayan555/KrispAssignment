...
public class KrispAccountScreenLocators {
    ...
    public static final String HELP_BUTTON = "/html/body/div[1]/section/section/header/div/div[1]";
    public static final String WHATS_NEW_BUTTON = "What’s new";
    public static final String SIGN_OUT_BUTTON = "//*[@data-test-id = 'signOutButton']";
}
